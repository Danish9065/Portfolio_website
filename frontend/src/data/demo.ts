...
export const DEMO_SKILLS: Skill[] = [
  { id: "skill-react", name: "React", category: "Frontend", level: 90, icon: null, sort_order: 1, is_featured: true },
  { id: "skill-typescript", name: "TypeScript", category: "Frontend", level: 88, icon: null, sort_order: 2, is_featured: true },
  { id: "skill-fastapi", name: "FastAPI", category: "Backend", level: 84, icon: null, sort_order: 3, is_featured: true },
  { id: "skill-postgres", name: "PostgreSQL", category: "Database", level: 82, icon: null, sort_order: 4, is_featured: true },
  { id: "skill-supabase", name: "Supabase", category: "Platform", level: 80, icon: null, sort_order: 5, is_featured: true },
  { id: "skill-cloud", name: "Cloud integrations", category: "Platform", level: 78, icon: null, sort_order: 6, is_featured: true },
];
...
export const DEMO_SERVICES: Service[] = [
  ...
  { id: "service-integration", title: "API integrations", slug: "api-integrations", description: "Wire real services without exposing secrets or faking success states.", features: ["Backend-owned secrets", "Error handling", "Documentation"], starting_price: "Quote after integration review", icon: null, sort_order: 3 },
];

export const DEMO_TESTIMONIALS: Testimonial[] = [
  { id: "testimonial-demo-1", name: "Demo testimonial", role: "Replace before publishing", company: null, quote: "This is clearly marked sample testimonial content. Replace it with a real permissioned quote.", avatar_url: null, rating: null },
  { id: "testimonial-demo-2", name: "Demo reviewer", role: "Editable sample", company: null, quote: "Use this area only for real client, employer, or collaborator feedback once available.", avatar_url: null, rating: null },
];

export const DEMO_HOME_CONTENT: HomeContent = {
  hero: {
    nav: [
